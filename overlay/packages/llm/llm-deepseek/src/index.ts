...
const DEFAULT_MODELS: DeepSeekCatalogModel[] = [
  {
    ...
    description: 'Native multimodal flagship; fast, efficient, and economical; suited to agentic coding and focused, routine, or parallel tasks.',
  ...
  // The retired `deepseek-v4-flash` and `deepseek-v4-flash-vision-exp` ids stay
  // callable: the public API routes them to V4.1 Flash and they pass through as
  // text-only routes when unlisted.
]
