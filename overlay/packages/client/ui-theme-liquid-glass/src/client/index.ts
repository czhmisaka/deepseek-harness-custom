...
function applyParams(theme: ThemeRuntime, params: LiquidGlassSettings): void {
  ...
  if (params.enabled) {
    ...
    const fx = {
      ...
      pixelPosterize: params.pixelPosterize,
      charset: params.charset,
      opacity: params.opacity,
      colorWave: params.colorWave,
      layerGrid: params.layerGrid,
      layerDigits: params.layerDigits,
      layerGradient: params.layerGradient,
      layerRays: params.layerRays,
      layerWave: params.layerWave,
    }
